...
class FW_Extension_Backups_Demo extends FW_Extension {
	...
	protected function _init() {
		add_action('fw_backend_add_custom_extensions_menu', array($this, '_admin_action_admin_menu'));
	...
	private function is_page() {
		...
		return (
			...
			&&
			$current_screen->id === $my_theme->get( 'TextDomain' ).'_page_'. $this->get_page_slug()
		);
	}
